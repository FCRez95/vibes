...
export class Rat implements MonsterModel {
  id: string;
  monster: string;
  health: number;
  maxHealth: number;
  ...
  constructor(id: string, x: number = 0, y: number = 0, health: number = 30, lairX: number = 0, lairY: number = 0, target: PlayerModel | null = null) {
    this.id = id;
    this.monster = "Rat";
    this.maxHealth = 30;
    this.health = health;
