...
import orcSprite from '../../../../public/assets/monsters/orc-gif.webp';

export class Orc implements MonsterModel {
  id: string;
  monster: string;
  health: number;
  maxHealth: number;
  ...
  constructor(id: string, x: number = 0, y: number = 0, health: number = 100, lairX: number = 0, lairY: number = 0, target: PlayerModel | null = null) {
    this.id = id;
    this.monster = "Orc";
    this.maxHealth = 100;
    this.health = health;
